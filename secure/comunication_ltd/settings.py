"""
Django settings for comunication_ltd project (SECURE version).
"""
...
SECRET_KEY = 'django-insecure-qz=-3^0iy^^&#pu$cjm*2@#!f6dje-zvvt=o&48tj5$_tzv!r('
